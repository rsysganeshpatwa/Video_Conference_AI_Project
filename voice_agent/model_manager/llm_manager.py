...
class LLMManager:
    ...
    def get_llm_response(self, identity: str, user_query: str, stream: bool = True) -> str:
        ...
        if stream:
            ...
            response_text = self.model_service.voice_chat(chat_history)
    ...
    def clean_user_query_with_model(self, query: str) -> str:
        ...
        try:
            ...
            refined = self.model_service.voice_chat(messages)
            print(f"🔄 Refined query: {refined}")
            return refined
        except Exception as e:
            print(f"⚠️ Error refining query with model: {e}")
            print("🔄 Falling back to basic query cleaning...")
            # Fallback to basic cleaning method
            return self.clean_user_query(query)
    ...
    def summarize_snippets(self, snippet_text: str, original_query: str) -> str:
        ...
        return self.model_service.voice_chat(messages)
